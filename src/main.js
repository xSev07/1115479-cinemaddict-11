...
// const createFilmsExtraTemplate = (header) => {
//   return (`
...
filmsExtraElement.forEach((it) => {
  ...
  for (let i = 0; i < FilmsQuantity.ADDITIONAL; i++) {
    render(filmsListExtraElement, createFilmCardTemplate());
  }
});

render(siteFooterElement, createFilmDetailsTemplate(), PlaceInsert.AFTER_END);
